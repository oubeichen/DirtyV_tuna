...
ifdef CCONFIG_CC_OPTIMIZE_O3
 KBUILD_CFLAGS_KERNEL := -O3 -mtune=cortex-a9 -march=armv7-a -mfpu=neon -fno-tree-vectorize
else
 KBUILD_CFLAGS_KERNEL := -O2 -mtune=cortex-a9 -march=armv7-a -mfpu=neon -fno-tree-vectorize
endif
